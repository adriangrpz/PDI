...
class Interface(Frame):
    ...
    def toolbar(self):
        ...
        filtersMenu.add_command(label='Azar',           command=lambda: self.apply(azar))
        ...
        convolution.add_command(label="Bordes 2",       command=lambda: self.apply(borders2))
        convolution.add_command(label="Bordes 3",       command=lambda: self.apply(borders3))
        convolution.add_command(label="Bordes 4",       command=lambda: self.apply(borders4))
        convolution.add_command(label="Sharpen 1",      command=lambda: self.apply(sharpen1))
        convolution.add_command(label="Sharpen 2",      command=lambda: self.apply(sharpen2))
        convolution.add_command(label="Sharpen 3",      command=lambda: self.apply(sharpen3))
        convolution.add_command(label="Emboss 1",       command=lambda: self.apply(emboss1))
        convolution.add_command(label="Emboss 2",       command=lambda: self.apply(emboss2))
